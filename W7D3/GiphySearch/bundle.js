...
exports.fetchSearchGiphys = undefined;

var _keystore = __webpack_require__(116);
...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: 'http://api.giphy.com/v1/gifs/search?q=' + searchTerm + '&api_key=' + _keystore2.default + '&limit=2'
  });
};
...
var API_KEY = "adf48ab3c7c6436280593c5d0bf5ba3d";

exports.default = API_KEY;
